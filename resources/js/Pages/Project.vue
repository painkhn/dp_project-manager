    ...
    <main>
        ...
        <div class="w-full mx-auto p-5 my-0 rounded-xl flex gap-5">
            <div class="w-2/3">
                ...
                <form @submit.prevent="handleSubmit" action="" v-if="isNewTaskVisible" class="flex flex-col gap-5">
                ...
                <div v-if="(props.tasks as Tasks[])?.length > 0" class="my-5">
                    <ul>
                        <li v-for="(task, index) in props.tasks" :key="index">
                            <div class="w-full px-4 py-2 border-l-4 transition-all hover:bg-white/10">
