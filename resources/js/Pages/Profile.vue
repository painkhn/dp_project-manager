                ...
                <ul class="flex flex-col items-center gap-10 max-w-[170px] mx-auto">
                    <li class="">
                        <div class="avatar cursor-pointer" @click="avatarChangeIsVisible" v-if="$page.props.auth.user.id == ($page.props.user as User).id">
                            <img v-if="props.user.avatar == null" src='/img/avatar_default.jpg' class="profileInfo__avatar w-40 h-40 rounded-full border-[3px] border-white" alt="">
                            <img v-else :src="`/storage/` + props.user.avatar" alt="Аватарка" encType="multipart/form-data" class="profileInfo__avatar border-[3px] w-40 h-40 rounded-full border-white">
                        </div>
                        <div v-else>
                            <img v-if="props.user.avatar == null" src='/img/avatar_default.jpg' class="profileInfo__avatar w-40 h-40 rounded-full border-[3px] border-white" alt="">
                            <img v-else :src="`/storage/` + props.user.avatar" alt="Аватарка" encType="multipart/form-data" class="profileInfo__avatar w-40 h-40 border-[3px] rounded-full border-white">
                        </div>
