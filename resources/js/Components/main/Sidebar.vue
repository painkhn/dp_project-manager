...
<template>
    <aside id="default-sidebar" :class="['fixed top-0 left-0 z-40 w-64 h-screen transition-transform', { '-translate-x-full': !isVisible }]" aria-label="Sidenav">
        <div class="overflow-y-auto py-5 px-3 h-full bg-white border-r border-gray-200 dark:bg-black dark:border-gray-700">
            <ul class="space-y-2">
                ...
                <li v-if="$page.props.auth.user">
                    <button type="button" class="flex items-center p-2 w-full text-base font-normal text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-white/10" aria-controls="dropdown-pages" data-collapse-toggle="dropdown-pages">
                        ...
                        <span class="flex-1 ml-3 text-left whitespace-nowrap">Страницы</span>
                ...
                <li>
                    <button type="button" class="flex items-center p-2 w-full text-base font-normal text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-white/10" aria-controls="dropdown-authentication" data-collapse-toggle="dropdown-authentication">
                        ...
                        <span class="flex-1 ml-3 text-left whitespace-nowrap">Аккаунт</span>
                        <svg aria-hidden="true" class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
                    </button>
                    <ul id="dropdown-authentication" class="hidden py-2 space-y-2">
                        ...
                        <li v-if="!$page.props.auth.user">
                            <Link :href="route('register')" class="flex items-center p-2 pl-11 w-full text-base font-normal text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-white/10">Регистрация</Link>
                        </li>
                    </ul>
                </li>
            </ul>
            <ul class="pt-5 mt-5 space-y-2 border-t border-gray-200 dark:border-gray-700">
                <li>
                    <a href="#" class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg transition duration-75 hover:bg-gray-100 dark:hover:bg-white/10 dark:text-white group">
        ...
        <div class="hidden absolute bottom-0 left-0 justify-end p-4 w-full lg:flex bg-white dark:bg-black z-20 border-r border-gray-200 dark:border-gray-700">
            <button @click="sidebarToggle" type="button" class="inline-flex justify-center p-2 text-gray-500 rounded cursor-pointer dark:hover:text-white dark:text-gray-400 hover:text-gray-900 hover:bg-gray-100 dark:hover:bg-white/10">
